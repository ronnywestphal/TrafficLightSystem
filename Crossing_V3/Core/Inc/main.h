...
#define S_PSw_Pin GPIO_PIN_15
#define S_PSw_GPIO_Port GPIOA
#define S_PSw_EXTI_IRQn EXTI15_10_IRQn
...
#define N_PSw_Pin GPIO_PIN_7
#define N_PSw_GPIO_Port GPIOB
#define N_PSw_EXTI_IRQn EXTI9_5_IRQn
